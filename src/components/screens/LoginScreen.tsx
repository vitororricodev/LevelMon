  ...
  return (
    <div className="flex flex-col items-center justify-between h-full px-6 py-10 text-center">
      <div className="w-full pt-2">
        <img
          src="/levelmon-logo.png"
          alt="Logo LevelMon"
          className="mx-auto h-56 w-56 object-contain drop-shadow-[0_12px_30px_rgba(93,132,55,0.28)]"
          draggable={false}
        />
        <p
          className="-mt-4 text-4xl font-black tracking-[0.08em]"
          style={{
      ...
      <div className="flex flex-col items-center gap-5">
        <p className="text-sm text-muted-foreground max-w-xs">Seu corpo, sua aventura.</p>
...
function GoogleIcon() {
  return (
    <svg width="18" height="18" viewBox="0 0 48 48">
      <path
        fill="#EA4335"
        d="M24 9.5c3.5 0 6.6 1.2 9 3.6l6.7-6.7C35.5 2.4 30.1 0 24 0 14.6 0 6.5 5.4 2.5 13.3l7.8 6.1C12.3 13.1 17.7 9.5 24 9.5z"
      />
      <path
        fill="#4285F4"
        d="M46.5 24.5c0-1.7-.2-3.3-.5-4.9H24v9.3h12.7c-.6 3-2.3 5.5-4.8 7.2l7.5 5.8c4.4-4 7.1-10 7.1-17.4z"
      />
      <path
        fill="#FBBC05"
        d="M10.3 28.6c-.5-1.4-.8-2.9-.8-4.6s.3-3.2.8-4.6l-7.8-6.1C.9 16.5 0 20.1 0 24s.9 7.5 2.5 10.7l7.8-6.1z"
      />
      <path
        fill="#34A853"
        d="M24 48c6.1 0 11.3-2 15-5.5l-7.5-5.8c-2.1 1.4-4.8 2.3-7.5 2.3-6.3 0-11.7-3.6-13.7-8.8l-7.8 6.1C6.5 42.6 14.6 48 24 48z"
      />
    </svg>
  );
}
